<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Nhớ mật khẩu') }}</span>
            </label>
        </div>
    ...
    <br>
    <div  class="flex items-center justify-end mt-4">
        <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">Chưa có tài khoản click ngay:</span>
